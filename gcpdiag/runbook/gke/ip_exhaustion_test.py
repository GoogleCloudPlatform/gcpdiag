...
class TestIpExhaustionUnit(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.enterContext(mock.patch('gcpdiag.runbook.op.get_context', autospec=True))
    self.enterContext(
      mock.patch(
  ...
  def test_start_step_cluster_not_found(
    self, mock_skip, mock_get_cluster, unused_mock_get_project, mock_op_get
  ):
  ...
  def test_node_exhaustion_detected(
    self, mock_failed, mock_query, unused_mock_get_cluster, mock_op_get
  ):
  ...
  @mock.patch('gcpdiag.runbook.gke.ip_exhaustion.local_realtime_query')
  @mock.patch('gcpdiag.runbook.op.add_failed')
  def test_pod_exhaustion_autopilot_detected(
    self, mock_failed, mock_query, mock_get_cluster, mock_op_get
  ):
  ...
  def test_end_step_resolution_confirmation(
    self, mock_info, mock_prompt, mock_op_get, mock_config_get
  ):
  ...
  def test_build_tree(self):
    ...
    self.assertIsInstance(tree.start.steps[0], ip_exhaustion.NodeIpRangeExhaustion)
    self.assertIsInstance(tree.start.steps[1], ip_exhaustion.IpExhaustionEnd)
    self.assertIsInstance(tree.start.steps[0].steps[0], ip_exhaustion.PodIpRangeExhaustion)

  @mock.patch('gcpdiag.runbook.op.get')
  @mock.patch('gcpdiag.queries.crm.get_project')
  @mock.patch('gcpdiag.queries.gke.get_cluster')
  @mock.patch('gcpdiag.runbook.op.add_ok')
  def test_start_step_cluster_found(
    self, mock_ok, mock_get_cluster, unused_mock_get_project, mock_op_get
  ):
  ...
  @mock.patch('gcpdiag.runbook.gke.ip_exhaustion.local_realtime_query')
  @mock.patch('gcpdiag.runbook.op.add_ok')
  def test_node_exhaustion_not_found(
    self, mock_ok, mock_query, unused_mock_get_cluster, mock_op_get
  ):
  ...
  @mock.patch('gcpdiag.runbook.op.add_failed')
  @mock.patch('gcpdiag.runbook.op.info')
  def test_pod_exhaustion_standard_cluster_detected(
    self, mock_info, mock_failed, mock_query, mock_get_cluster, mock_op_get
  ):
  ...
  @mock.patch('gcpdiag.runbook.gke.ip_exhaustion.local_realtime_query')
  @mock.patch('gcpdiag.runbook.op.add_ok')
  def test_pod_exhaustion_not_found(self, mock_ok, mock_query, mock_get_cluster, mock_op_get):
