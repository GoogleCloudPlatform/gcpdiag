...
def build_api(
  service_name: str, api_base_url: str, creds: api.Creds, retry_strategy: api.RetryStrategy
) -> object:
  ...
  if service_name == 'datafusion':
    ...
    return datafusion.Datafusion(api_base_url, creds=creds, retry_strategy=retry_strategy)
  else:
