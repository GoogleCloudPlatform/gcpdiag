...
from gcpdiag.async_queries.api import api, constant_time_retry_strategy, test_webserver
...
class TestAPI(unittest.IsolatedAsyncioTestCase):
  ...
  async def asyncSetUp(self) -> None:
    ...
    self._server = test_webserver.WebServer(port=self._port, expected_auth_token=self._token)
  ...
  async def test_get_response(self) -> None:
    ...
    result = await self._api.call(method='GET', url=f'http://localhost:{self._port}/test')
