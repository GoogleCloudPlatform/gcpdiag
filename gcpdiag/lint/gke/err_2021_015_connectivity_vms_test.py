...
"""Test code in err_2021_015_connectivity_vms.py."""
...
from gcpdiag.lint.gke import err_2021_015_connectivity_vms
...
class Test:
  ...
  def test_run_rule(self, snapshot):
    ...
    rule = lint.LintRule(product='test',
                         ...
                         run_rule_f=err_2021_015_connectivity_vms.run_rule)
