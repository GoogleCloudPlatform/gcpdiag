...
The local user "" lacks at least one valid SSH key for VM: "".

### Failure Remediation

Ensure "" has a valid SSH key by following the guide:
https://cloud.google.com/compute/docs/connect/add-ssh-keys#add_ssh_keys_to_instance_metadata

### Success Reason

The local user "" is confirmed to have at least one valid SSH key
configured on the GCE VM: "".
