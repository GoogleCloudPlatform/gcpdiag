...
gce     | WARN  | 2021_003 | GCE instance service account permissions for monitoring.     | The service account used by GCE instance should have the monitoring.metricWriter permission, otherwise, if you install the ops or monitoring agent, it won't be able to send the metrics to Cloud Monitoring.
